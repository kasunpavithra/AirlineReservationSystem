    ...
    if (error) {
        ...
        if(error){
            ...
            try {
                ...
                navigate(`/bookSeat`,{...prop.data,'guestUserID':response.data.result.insertId});
                }
    ...
    <h1 className='fs-1 text-primary mb-5'>Booking Details </h1>
     <Form onSubmit={handleSubmit} >
        ...
        <Form.Group as={Row} className='fw-bold col-xl-12 mb-3 mx-auto' controlId='Email'>
           ...
           <Col sm={7}>
           <Form.Control style={{"font-family":"FontAwesome"}}   type="text" name='Email'  value={state["Email"]} placeholder='&#xf0e0; Email' onChange={handleUser}/>
           </Col>
           <Row>
                <Col>
                </Col>
