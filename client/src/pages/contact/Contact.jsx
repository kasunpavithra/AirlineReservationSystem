...
import ticketPic from "./assets/ticket.jpg"
import discountsPic from "./assets/sale.jpg"
import searchPic from "./assets/searchjpg.jpg"
import schedulePic from "./assets/schedulejpg.jpg"
import './Contact.css';
...
const Contact = () => {
    return (
        ...
        <div className="about" >
            ...
            <h1 className="about_header margin-top" >What we offer</h1> <br />

            <div className="container cont justify-content-center">

                <div className="row">
                    <div className="about_card col-lg-2 col-md-5">
                        <div className="image">
                            <img src={ticketPic} className="contact-img" alt="" />
                        </div> <br />
                        <h5 className="h_6">Book tickets even without registering with the system</h5>
                    </div>
                    ...
                    <div className="about_card col-lg-2 col-md-5">
                        <div className="image">
                            <img src={discountsPic} className="contact-img" alt="" />
                        </div> <br />
                        <h5 className="h_6">Get registered to be eligible for discounts (5%, 9% on each booking)</h5>
                    </div>
                    ...
                    <div className="about_card col-lg-2 col-md-5">
                        <div className="image">
                            <img src={searchPic} className="contact-img" alt="" />
                        </div> <br />
                        <h5 className="h_6">View your bookings history</h5>
                    </div>
                    ...
                    <div className="about_card col-lg-2 col-md-5">
                        <div className="image">
                            <img src={schedulePic} className="contact-img" alt="" />
                        </div> <br />
                        <h5 className="h_6">See flight schedule</h5>
                    </div>
                </div>
            ...
            <br /><br />
            <div className="container cont footer justify-content-center">
                <p>We, the bairways is a proud subsidiary of one of the leading airways companies in Indonesia: Virgin Airlines.
                    With over 18 years of expertise in the field we have provided an excellent service for more than thousands customers till now.
                    You can explore your favourite destinations arounf the globe with us. You can now book tickets even without registering with our online
                    system. But in order to be eligible for discounts you should be making bookings with a registered account. There is a <b> 5% discount </b>
                    on every booking that you made, if you have already done total of 5 or more booking. Also, if you have done total of 10 or more
                    bookings in past, you can have <b>9% discount </b> on all the future booking that you make.
                </p>
            </div> <br /> <br />
            ...
            <section>
                <div className="landing-footer">
                    ...
                    <div className="landing-footer-col">
                        <h1>CONTACT US</h1>
                        <p>Email: bairways@gmail.com</p>
                        <p>Tel: 071 12345678</p>
                        <p><a href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
