...
const AdminDashboardContent = () => {
    ...
    // ({ data1, isPending, error } = useFetch("http://localhost:3001/api/authorized-user/total"))

    // var totalRegUsers = ''
    // var totalAuthorizedusers = ''
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:3001/api/authorized-user/total")
            .then(result => {
                settotalAuthorizedusers(result.data.result[0].total)
            })
            .catch(err => {
                console.log(err);
            })
    }, [totalAuthorizedusers, totalRegUsers])
    ...
    return (
        <>
            <div className="page-wrapper">
                ...
                <div className="row row-cols-1 row-cols-md-2 row-cols-xl-2 cards-set">
                    <div className="col">
                            ...
                            <div className="card-body">
                                <div className="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 className="my-1 text-success">{totalRegUsers}</h4>
                            ...
                            <div className="card-body">
                                <div className="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 className="my-1 text-warning">{totalAuthorizedusers}</h4>
